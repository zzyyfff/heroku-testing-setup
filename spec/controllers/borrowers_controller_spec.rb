...
RSpec.describe BorrowersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new borrower" do
        ...
        expect(response.location).to eq(borrower_url(Borrower.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the borrower" do
        borrower = Borrower.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the borrower" do
        borrower = Borrower.create! valid_attributes
